...
{
    internal class AssetPatcherFeature : FeatureImpl
    {
        ...
        private static string REPLACEMENTS_SECTION = "Replacements";
...
";
        ...
        public override void HandleDisabled()
        {
            SRPlugin.Harmony.Unpatch(
                typeof(Resources).GetMethod(nameof(Resources.Load)),
                typeof(ResourcesPatch).GetMethod(nameof(ResourcesPatch.LoadPostfix))
                );
        }
        ...
        public override void HandleEnabled()
        {
            ...
            SRPlugin.Harmony.PatchAll(typeof(ResourcesPatch));
        }
